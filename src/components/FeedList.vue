<template>
    <div class="feedParentContainer">
        ...
        <mt-loadmore ref="loadmore" v-if="!nothing" :autoFill='false' :bottomDistance="70" :top-method="loadTop" :bottom-method="loadBottom" :top-all-loaded="topAllLoaded" :bottom-all-loaded="bottomAllLoaded" :bottomPullText="`上拉加载更多`" :bottomDropText="`释放加载更多`">

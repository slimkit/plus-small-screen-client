<template>
  <div :class="prefixCls">
    <head-top :go-back='cancel' append='true' title='全站粉丝排行榜'>
      <div slot='append'>
...
<script>
  ...
  export default {
    ...
    created () {
      this.users = this.$store.getters.getUsersByType('rankFollowers')
    }
  }
</script>

<style lang="less">
  @prefixCls: rankFollowers;

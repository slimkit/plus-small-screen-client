<template>
  <div :class="prefixCls">
    <head-top :go-back='cancel' append='true' title='收入达人排行榜'>
      <div slot='append'>
...
<script>
  ...
  export default {
    ...
    created () {
      this.users = this.$store.getters.getUsersByType('rankIncome')
    }
  }
</script>

<style lang="less">
  @prefixCls: rankIncome;
